...
GattCharacteristic &GattCharacteristic::registerNotifyTrigger(RegisterNotiCallback callback)
{
	if (callback != nullptr) {
		(*callback)(*this);
	}
...
//     Input args: void
//     Output args: void
GattCharacteristic &GattCharacteristic::onStartNotify(MethodCallback callback)
{
	static const char *inArgs[] = {nullptr};
	addMethod("StartNotify", inArgs, nullptr, reinterpret_cast<DBusMethod::Callback>(callback));
	return *this;
}
...
//     Input args: void
//     Output args: void
GattCharacteristic &GattCharacteristic::onStopNotify(MethodCallback callback)
{
	static const char *inArgs[] = {nullptr};
	addMethod("StopNotify", inArgs, nullptr, reinterpret_cast<DBusMethod::Callback>(callback));
	return *this;
}
