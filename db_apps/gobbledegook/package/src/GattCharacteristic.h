...
#define CHARACTERISTIC_REGISTER_NOTIFY_LAMBDA [] \
( \
       const GattCharacteristic &self \
)
...
struct GattCharacteristic : GattInterface
{
	...
	typedef void (*RegisterNotiCallback)(const GattCharacteristic &self);
	...
	GattCharacteristic &registerNotifyTrigger(RegisterNotiCallback callback);
	...
	//     Input args: void
	//     Output args: void
	GattCharacteristic &onStartNotify(MethodCallback callback);
	...
	//     Input args: void
	//     Output args: void
	GattCharacteristic &onStopNotify(MethodCallback callback);
