...
--[[
Invoke registration with installation parameters and signature
@param params Registration parameters table.
@param cpi_signature Signature data that signs the params
@return true if success, false otherwise
--]]
local function invoke_registration(params, cpi_signature)

    if not (params.latitude and params.longitude and params.height and params.azimuth and params.downtilt
            and params.cpi_id and params.cpi_name and params.install_certification_time and params.height_type) then
        return nil
    end

    if cpi_signature then
        ...
        m_luardb.set("sas.config.cpiSignatureData", cpi_signature)
...
return {
    ...
    generate_cpi_signature_data = generate_cpi_signature_data
}
