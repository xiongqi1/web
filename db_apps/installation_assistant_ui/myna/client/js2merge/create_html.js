...
function buildScanResultTable(data, full_mode) {
    ...
    var color_text = function(value, limit) {
        scanResultTable += "<td";
        if (full_mode) {
            scanResultTable += " class=\"" + (value < limit ? "red" : "green") + "-font\"";
        }
        scanResultTable += ">" + value + "</td>\n";
    }
    ...
    for (var i = 0; i < data.current_readings.length; i++) {
        ...
        color_text(data.current_readings[i].rsrp, data.current_readings[i].rsrp_pass);
        ...
        color_text(data.current_readings[i].rsrq, data.limits.RSRQ.pass);
        scanResultTable += "</tr>\n";
    }
