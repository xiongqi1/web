...
** source XML file: si3217x_LCUB_constants.xml
**
...
0x06976347L,	/* VBATR_EXPECT (102.990 v) */
...
0x58,			/* RINGCON */
0x01,			/* USERSTAT */
0x034BB1A3L,	/* VCM_RING (50.245 v) */
0x034BB1A3L,	/* VCM_RING_FIXED */
