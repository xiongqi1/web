...
0x00A18937L,	/* VOV_DCDC_OS */
0x00E49BA5L,	/* VOV_RING_BAT_MAX */
0xFFFF6000L,	/* SMART_RING_PERIOD */
0xFFFFD800L,	/* SMART_RING_PHASE */
},  /* FR_RINGING */
{
/*
	Loop = 500.0 ft @ 0.044 ohms/ft, REN = 5, Rcpe = 600 ohms
...
{0x00B3D800L, 0x1D2F8280L, 0x021C8B00L, 0x0A157F00L,    /* ZSYNTH */
 ...
 -30, -90  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -3, -9  /* TXGAIN, RXGAIN */
#endif
 },  /* AU_IMPEDANCE */
...
#ifdef ENABLE_HIRES_GAIN
 -40, -60  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -4, -6  /* TXGAIN, RXGAIN */
#endif
 },  /* AUS_IMPEDANCE */
...
{0x1F657980L, 0x0096FE00L, 0x00035500L, 0x0D7FE800L,    /* ZSYNTH */
 ...
 0x07BC8400L, 0x18437C80L, 0x07790880L,    /* RXACHPF */
#ifdef ENABLE_HIRES_GAIN
 -30, -60  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -3, -6  /* TXGAIN, RXGAIN */
#endif
 },  /* BE_IMPEDANCE */
...
#ifdef ENABLE_HIRES_GAIN
 -40, -110  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -4, -11  /* TXGAIN, RXGAIN */
#endif
 },  /* BR_IMPEDANCE */
...
#ifdef ENABLE_HIRES_GAIN
 -20, -40  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -2, -4  /* TXGAIN, RXGAIN */
#endif
 },  /* CH_IMPEDANCE */
...
{0x1F657980L, 0x0096FE00L, 0x00035500L, 0x0D7FE800L,    /* ZSYNTH */
 ...
 0x07BC8400L, 0x18437C80L, 0x07790880L,    /* RXACHPF */
#ifdef ENABLE_HIRES_GAIN
 -40, -6  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -4, 0  /* TXGAIN, RXGAIN */
#endif
 },  /* ETSI_IMPEDANCE */
...
{0x1F657980L, 0x0096FE00L, 0x00035500L, 0x0D7FE800L,    /* ZSYNTH */
 ...
 0x07BC8400L, 0x18437C80L, 0x07790880L,    /* RXACHPF */
#ifdef ENABLE_HIRES_GAIN
 -40, -100  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -4, -10  /* TXGAIN, RXGAIN */
#endif
 },  /* FI_IMPEDANCE */
...
{0x1F657980L, 0x0096FE00L, 0x00035500L, 0x0D7FE800L,    /* ZSYNTH */
 ...
 0x07BC8400L, 0x18437C80L, 0x07790880L,    /* RXACHPF */
#ifdef ENABLE_HIRES_GAIN
 -30, -30  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -3, -3  /* TXGAIN, RXGAIN */
#endif
 },  /* IT_IMPEDANCE */
...
#ifdef ENABLE_HIRES_GAIN
 -20, -30  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -2, -3  /* TXGAIN, RXGAIN */
#endif
 },  /* GR57_IMPEDANCE */
...
{0x1F657980L, 0x0096FE00L, 0x00035500L, 0x0D7FE800L,    /* ZSYNTH */
 ...
 0x07BC8400L, 0x18437C80L, 0x07790880L,    /* RXACHPF */
#ifdef ENABLE_HIRES_GAIN
 -40, -90  /* TXGAIN*10, RXGAIN*10 (hi_res) */
#else
 -4, -9  /* TXGAIN, RXGAIN */
#endif
 },  /* UK_IMPEDANCE */
