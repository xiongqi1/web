...
AUTO_ZCAL_ENABLED,          /* ZCAL_ENABLE */
BO_STD_BOM,                 /* PM_BOM */
2600L,                      /* I_OITHRESH (2600mA) */
900L,                       /* I_OITHRESH_LO (900mA) */
2600L,                      /* I_OITHRESH_HI (2600mA) */
128000L,                    /* V_OVTHRESH (128000mV) */
5000L,                      /* V_UVTHRESH (5000mV) */
1000L,                      /* V_UVHYST (1000mV) */
0x00000000L,                /* DCDC_FSW_VTHLO */
...
AUTO_ZCAL_ENABLED,          /* ZCAL_ENABLE */
BO_STD_BOM,                 /* PM_BOM */
4000L,                      /* I_OITHRESH (4000mA) */
1700L,                      /* I_OITHRESH_LO (1700mA) */
4000L,                      /* I_OITHRESH_HI (4000mA) */
138000L,                    /* V_OVTHRESH (138000mV) */
5000L,                      /* V_UVTHRESH (5000mV) */
1000L,                      /* V_UVHYST (1000mV) */
0x00000000L,                /* DCDC_FSW_VTHLO */
0x00000000L,                /* DCDC_FSW_VHYST */
...
0x00083120L,                /* BAT_HYST */
0x03D70A20L,                /* VBATH_EXPECT (60.00V) */
0x08D4FDB0L,                /* VBATR_EXPECT (138.00V) */
0x0FFF0000L,                /* PWRSAVE_TIMER */
0x01999A00L,                /* OFFHOOK_THRESH */
0x00F00000L,                /* VBAT_TRACK_MIN */
0x00F00000L,                /* VBAT_TRACK_MIN_RNG */
...
AUTO_ZCAL_ENABLED,          /* ZCAL_ENABLE */
BO_STD_BOM,                 /* PM_BOM */
3400L,                      /* I_OITHRESH (3400mA) */
900L,                       /* I_OITHRESH_LO (900mA) */
3400L,                      /* I_OITHRESH_HI (3400mA) */
138000L,                    /* V_OVTHRESH (138000mV) */
5000L,                      /* V_UVTHRESH (5000mV) */
1000L,                      /* V_UVHYST (1000mV) */
0x00000000L,                /* DCDC_FSW_VTHLO */
...
{ /*  SI3217X_GEN_PARAM_LCFB */ 
0x76,                       /* DEVICE_KEY */
BO_DCDC_LCFB,               /* BOM_OPT */
BO_GDRV_NOT_INSTALLED,      /* GDRV_OPTION */
VDC_9P0_16P0,               /* VDC_RANGE_OPT */
VDAA_DISABLED,              /* DAA_ENABLE */
AUTO_ZCAL_ENABLED,          /* ZCAL_ENABLE */
BO_STD_BOM,                 /* PM_BOM */
5800L,                      /* I_OITHRESH (5800mA) */
3000L,                      /* I_OITHRESH_LO (3000mA) */
5800L,                      /* I_OITHRESH_HI (5800mA) */
138000L,                    /* V_OVTHRESH (138000mV) */
5000L,                      /* V_UVTHRESH (5000mV) */
1000L,                      /* V_UVHYST (1000mV) */
0x00000000L,                /* DCDC_FSW_VTHLO */
...
0x00000000L,                /* DCDC_UVPOL */
0x00200000L,                /* DCDC_RNGTYPE */
0x00140000L,                /* DCDC_ANA_TOFF */
0x00080000L,                /* DCDC_ANA_TONMIN */
0x00250000L,                /* DCDC_ANA_TONMAX */
0x50,                       /* IRQEN1 */
0x13,                       /* IRQEN2 */
0x03,                       /* IRQEN3 */
0x00,                       /* IRQEN4 */
...
0x06978372L,	/* VBATR_EXPECT (102.998 v) */
...
0x58,			/* RINGCON */
0x01,			/* USERSTAT */
0x034BC1B9L,	/* VCM_RING (50.249 v) */
0x034BC1B9L,	/* VCM_RING_FIXED */
