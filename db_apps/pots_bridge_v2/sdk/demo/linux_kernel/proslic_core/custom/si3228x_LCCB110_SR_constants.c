...
** source XML file: si3228x_LCCB110_SR_constants.xml
**
...
/*
	...
	Rprot = 54 ohms, Type = SMART_RINGING, Waveform = SINE
*/ 
0x00050000L,	/* RTPER */
...
0x00166876L,	/* RINGAMP (45.000 vrms)  */
0x00000000L,	/* RINGPHAS */
0x00000000L,	/* RINGOF (0.000 vdc) */
0x15E5200EL,	/* SLOPE_RING (100.000 ohms) */
0x009FC50FL,	/* IRING_LIM (103.000 mA) */
0x008229D6L,	/* RTACTH (57.504 mA) */
0x0FFFFFFFL,	/* RTDCTH (450.000 mA) */
0x00004000L,	/* RTACDB (75.000 ms) */
0x00004000L,	/* RTDCDB (75.000 ms) */
0x0051EB82L,	/* VOV_RING_BAT (5.000 v) */
0x00000000L,	/* VOV_RING_GND (0.000 v) */
0x04F705DDL,	/* VBATR_EXPECT (77.577 v) */
0x80,			/* RINGTALO (2.000 s) */
0x3E,			/* RINGTAHI */
0x00,			/* RINGTILO (4.000 s) */
0x7D,			/* RINGTIHI */
...
0x98,			/* RINGCON */
0x00,			/* USERSTAT */
0x027B82EEL,	/* VCM_RING (37.539 v) */
0x027B82EEL,	/* VCM_RING_FIXED */
0x003126E8L,	/* DELTA_VCM */
0x00200000L,	/* DCDC_RNGTYPE */
0x00FFFFFFL,	/* VOV_DCDC_SLOPE */
0x00A18937L,	/* VOV_DCDC_OS */
...
0x00231875L,	/* RINGAMP (45.000 vrms)  */
0x00000000L,	/* RINGPHAS */
0x00000000L,	/* RINGOF (0.000 vdc) */
0x15E5200EL,	/* SLOPE_RING (100.000 ohms) */
0x009FC50FL,	/* IRING_LIM (103.000 mA) */
0x005401BBL,	/* RTACTH (57.989 mA) */
0x0FFFFFFFL,	/* RTDCTH (450.000 mA) */
0x00008000L,	/* RTACDB (75.000 ms) */
0x00008000L,	/* RTDCDB (75.000 ms) */
0x0051EB82L,	/* VOV_RING_BAT (5.000 v) */
0x00000000L,	/* VOV_RING_GND (0.000 v) */
0x04F8643CL,	/* VBATR_EXPECT (77.661 v) */
0x80,			/* RINGTALO (2.000 s) */
0x3E,			/* RINGTAHI */
0x00,			/* RINGTILO (4.000 s) */
0x7D,			/* RINGTIHI */
...
0x98,			/* RINGCON */
0x00,			/* USERSTAT */
0x027C321EL,	/* VCM_RING (37.580 v) */
0x027C321EL,	/* VCM_RING_FIXED */
0x003126E8L,	/* DELTA_VCM */
0x00200000L,	/* DCDC_RNGTYPE */
0x00FFFFFFL,	/* VOV_DCDC_SLOPE */
0x00A18937L,	/* VOV_DCDC_OS */
...
0x002EE195L,	/* RINGAMP (45.000 vrms)  */
0x00000000L,	/* RINGPHAS */
0x00000000L,	/* RINGOF (0.000 vdc) */
0x15E5200EL,	/* SLOPE_RING (100.000 ohms) */
0x009FC50FL,	/* IRING_LIM (103.000 mA) */
0x007E55F2L,	/* RTACTH (58.139 mA) */
0x0FFFFFFFL,	/* RTDCTH (450.000 mA) */
0x00006000L,	/* RTACDB (75.000 ms) */
0x00006000L,	/* RTDCDB (75.000 ms) */
0x0051EB82L,	/* VOV_RING_BAT (5.000 v) */
0x00000000L,	/* VOV_RING_GND (0.000 v) */
0x04F8D082L,	/* VBATR_EXPECT (77.686 v) */
0x80,			/* RINGTALO (2.000 s) */
0x3E,			/* RINGTAHI */
0x00,			/* RINGTILO (4.000 s) */
0x7D,			/* RINGTIHI */
...
0x98,			/* RINGCON */
0x00,			/* USERSTAT */
0x027C6841L,	/* VCM_RING (37.593 v) */
0x027C6841L,	/* VCM_RING_FIXED */
0x003126E8L,	/* DELTA_VCM */
0x00200000L,	/* DCDC_RNGTYPE */
0x00FFFFFFL,	/* VOV_DCDC_SLOPE */
0x00A18937L,	/* VOV_DCDC_OS */
