...
#
# $Id: extract_settings.pl 6070 2016-10-20 23:08:16Z nizajerk $
use File::Basename;
...
sub parse_fn
{
	...
	if(!(-d $output_dir))
	{
		system ("mkdir -p $output_dir 2> /dev/null") == 0 
			or die "failed to create ", $output_dir , ". exiting...\n";
	}
    ...
    while(<INPUT_FH>)
    {
        ...
        elsif(/.+define\W+SI3([0-9X]+)_CONSTANTS_H/)
        {
            ...
            print OUTPUT_FH "/* Copyright 2016, Silicon Labs */\n";
