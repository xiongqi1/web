...
*
* $Id: proslic_api_config.h 6799 2017-09-14 18:58:01Z nizajerk $
*
*
* Author(s):
* laj
...
#include <syslog.h>
#define LOGPRINT(...) syslog(LOG_DEBUG,__VA_ARGS__)
...
extern FILE
*SILABS_LOG_FP; /* This global variable would need to be initialized by the user's program - see the api demo for example */
