...
paginatedropdown.options.length=0 // clear out the array as old values above this.pagecount will remain and show in drop down options
...
paginatedropdown.options[i]=new Option((i+1)+"/"+this.pagecount+"ページ", i)
else
