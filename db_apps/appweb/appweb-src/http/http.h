...
#define MPR_HTTP_BUFSIZE			(8*1024)
#define MPR_HTTP_DOC_BUFSIZE		(8*1024)
#define MPR_HTTP_IN_BUFSIZE			(8*1024)
#else
...
#define MPR_HTTP_SERVER_NAME		""		// not disclosing server type & rev
...
#define MA_HTTP_SESSION_PREFIX "_xSessionId_"
...
#define	MPR_HANDLER_ALL	\
	(MPR_HANDLER_GET | MPR_HANDLER_POST | MPR_HANDLER_OPTIONS)
#else
#define	MPR_HANDLER_ALL	\
