...
declare function blockUI_alert(s:string, func?:()=>void): void;
declare function blockUI_alert_l(s:string, func?:()=>void): void;
declare function blockUI_wait(s:string): void;
declare function blockUI_wait_progress(s:string): void;
declare function set_progress_message(s:string): void;
...
declare function blockUI_cancel(s:string, c?:any): void;
...
declare function hostNameIpFilter(s : string) : string;
declare function nameFilter(s : string) : string;
declare function userNameFilter(s : string) : string;
...
declare function genHtmlMaskBlocksWithoutRequired(s : string) : string;
declare function maskBits(s: string): number;
declare function toUpTime(s: number): string;
declare function isValidMacAddress(s: string): boolean;
declare function blockUI_RebootWaiting(): void;
declare function is_large(addr1:any, addr2:any): boolean;
declare function ip_gap(addr1:any, addr2:any): number;
declare function ip_to_decimal(addr:any): number;
declare function decimal_to_ip(deci:number): any;
declare function checkIPrange(ipMin:any, ipMax:any, myip:any): boolean;
declare function isWithinHostIpRange(ip:any, mask:any, myip:any): boolean;
declare function passStrengthValidation(passStr: string, score: number): boolean;
