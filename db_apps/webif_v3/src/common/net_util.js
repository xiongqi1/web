...
// create subnet mask address block html codes without
// individual validation per each fields input
// @params n A name of the field to identify each fields
// @return A html code block
function genHtmlMaskBlocksWithoutRequired(n) {
	var valx = getRequiredValidateStr("validate_netmask");
