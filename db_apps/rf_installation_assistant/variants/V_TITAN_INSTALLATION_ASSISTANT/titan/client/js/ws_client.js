...
function onMessage(evt) {
    ...
    // determine the page we are on. On advanced page, we display a lot less stuff
    ...
    if (message_data.report_type == "Invalid") {
        ...
        if (message_data.report_type == "RfStats") {
            ...
            elem2 = document.getElementById("ShowAllCellButtonId");
            if (elem2 != null) {
                elem2.checked = message_data.show_non_dual_plmn_cells;
            }
            elem2 = document.getElementById("ShowFWICellButtonId");
            if (elem2 != null) {
                elem2.checked = message_data.show_fwi_cells_mode;
            }
            ...
            var ttest_button = document.getElementById("SpeedTestButtonId");
            if (ttest_button != null) {
                ttest_button.disabled = ret[1];
            }
            ...
            res = buildThroughputTestResult(message_data);
            elem = document.getElementById("ttResult");
            elem2 = document.getElementById("ReRunButtonId");
            if (elem2 != null) {
                elem2.disabled = message_data.data_connection_unavailable;
            }
