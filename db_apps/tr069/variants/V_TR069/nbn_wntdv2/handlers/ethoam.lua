...
------------------------------------------	
	...
	['**.Dot1ag.*.Mda.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(mda_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
	...
	['**.Dot1ag.*.Lmp.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(lmp_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
		create = CWMP.Error.ReadOnly,
		delete = CWMP.Error.InvalidArguments,
	...
	['**.Dot1ag.*.Ltm.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(ltm_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
		create = CWMP.Error.ReadOnly,
		delete = CWMP.Error.InvalidArguments,
	...
	['**.Dot1ag.*.Lbm.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(lbm_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
		create = CWMP.Error.ReadOnly,
		delete = CWMP.Error.InvalidArguments,
...
--------------------------------------	
	...
	['**.Y1731.*.Mda.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(y_mda_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
		create = CWMP.Error.ReadOnly,
		delete = CWMP.Error.InvalidArguments,
	...
	['**.Y1731.*.Lmp.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(y_lmp_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
		create = CWMP.Error.ReadOnly,
		delete = CWMP.Error.InvalidArguments,
	...
	['**.Y1731.*.Dmm.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(y_dmm_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
		create = CWMP.Error.ReadOnly,
		delete = CWMP.Error.InvalidArguments,
	...
	['**.Y1731.*.Slm.*'] = {
		...
		set =  function(node, name, value)
			...
			return setRDBValue(y_slm_rdb_mapping, node, name, value)
		end,
		unset = CWMP.Error.OK,
		create = CWMP.Error.ReadOnly,
		delete = CWMP.Error.InvalidArguments,
...
------------------------------------------	
	...
	['**.Dot1ag.*.Rmp'] = {
		init = function(node, name)
			...
			local id1, var_name =parse_path(name , 1)
		...
		create =  function(node, name)
			...
			local id1, var_name =parse_path(name, 2)
	...
	['**.Dot1ag.*.Rmp.*'] = {
		...
		delete = function(node, name)
			...
			local id1, id2, var_name=parse_rmp_path(name)
			local objectClass = dot1ag_rmp_ObjectClass[id1];
			if objectClass then
				-- delete the RDB instance
