...
local fileRollSize  = conf.stats.fileRollSize or 512000

server = assert(loadfile(us..'rollerserver.lua'))

server('prefix', fileRollBaseName, 'interval', fileRollPeriod, 'nfiles', fileRollCount, 'port', fileRollPort, 'size', fileRollSize)
