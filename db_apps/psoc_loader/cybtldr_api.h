...
/*
 * This structure holds the PSoC app metadata
 * It is read from the firmware image file or from the device
 */
struct psoc_appdata {
    unsigned long   siliconId;      // These define the type of chip
    unsigned char   siliconRev;
    /* The next 3 are attributes of the Cypress bootloadable component */
    unsigned short  appId;          // The application Id
    unsigned short  appVers;        // The appication version
    unsigned long   appCustomId;    // Space for some future stuff
    CyBtldr_ChecksumType   chksumtype;
};

#define PSOC_APPID_IO_MICE 0x1001
#define PSOC_APPID_GPS_MICE 0x1002
#define PSOC_APPID_RF_MICE 0x1003
#define PSOC_APPID_CHUBB_MICE 0x1004
#define PSOC_APPID_AERIS_MICE 0x1005
#define PSOC_APPID_IND_IO_MICE 0x1006
#define PSOC_APPID_GPS_CAN_MICE 0x1007
...
*   siliconRev        - The Silicon ID of the device
*   siliconRev        - The Silicon Rev of the device
...
*
*******************************************************************************/
EXTERN int CyBtldr_StartBootloadOperation(CyBtldr_CommunicationsData* comm, unsigned long * siliconId,
