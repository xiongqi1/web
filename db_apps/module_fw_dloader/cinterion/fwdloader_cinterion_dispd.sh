...
log "Start flashing LEDs"

# save current LED status to file because there could be
# lots of LEDs on external Mice boards.
led save ALL > /tmp/ledsave

# Exciting LED flashing
led reserve ALL
led set ALL brightness 255
led set ALL trigger timer 
led set ALL delay_on 0
led set ALL brightness 255
led set ALL delay_off 100
led set ALL delay_on 50
